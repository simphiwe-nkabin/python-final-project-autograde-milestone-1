...
from ingredient_class import InsufficientStockError
from inventory_planner import load_inventory, add_ingredient, view_inventory, check_recipe, save_inventory
...
def main():
    ...
    menu_options = {
        "1": "Add / update an ingredient",
        "2": "View inventory",
        "3": "Check a recipe against inventory",
        "4": "Exit"
    }
    ...
    while True:
        ...
        if choice == "1":
            ...
            try:
                check_recipe(inventory)
            except InsufficientStockError as e:
                print("\n Unable to make the selected recipe:")
                print(e)
                print("You can add the missing ingredients and try again.")
